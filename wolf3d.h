...
void create_decoration_texture(t_env *env, t_decor_texture *t, t_decoration_surface s);
...
void sprite_in_vision(t_player *player, t_obj *ob_sprites, t_env *env, float diff_angles);
...
void enemy_damage_die(t_player *player, t_obj *ob_sprites, t_env *env, t_pnt p);
...
void draw_sprite(SDL_Renderer *rend, t_player *player, t_obj *ob_sprites, t_env *env);
void render_map(SDL_Renderer *rend, t_player *player, t_obj *ob_sprites, t_env *env);
