...
void	gun_animation(SDL_Renderer *rend, t_player *player, SDL_Surface **shots)
{
	SDL_Texture	*tx_gun;
	SDL_Rect	rect_gun_s;
	SDL_Rect	rect_gun_d;
	...
	tx_gun = SDL_CreateTextureFromSurface(rend, shots[player->frame_gun_x]);
	SDL_RenderCopyEx(rend, tx_gun, &rect_gun_s,
